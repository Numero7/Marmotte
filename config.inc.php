...
//			'viewhtml' => array('title' => "Voir en HTML", 'level' => NIVEAU_PERMISSION_BASE, 'page' =>'export.php', 'icon' => 'img/html-icon-24px.png'),
	...
	$filtersReports = array(
			...
			'theme1' => array('name'=>"Mot-clef 1" , 'liste' => $topics, 'default_value' => "tous", 'default_name' => "tous"),
			'theme2' => array('name'=>"Mot-clef 2" , 'liste' => $topics, 'default_value' => "tous", 'default_name' => "tous"),
	...
	$filtersConcours = array(
			...
			'labo1' => array('name'=>"Labo1" , 'default_value' => "tous", 'default_name' => ""),
			'theme1' => array('name'=>"Mot-clef 1" , 'liste' => $topics, 'default_value' => "tous", 'default_name' => ""),
			'theme2' => array('name'=>"Mot-clef 2" , 'liste' => $topics, 'default_value' => "tous", 'default_name' => ""),
