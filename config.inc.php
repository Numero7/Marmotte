...
$nonEditableFieldsTypes = array('id','date',"nom","prenom","infos_celcc","infos_evaluation","voeux","statut_celcc");
...
$actions_level = array(
		       ...
		       "purge_units" => NIVEAU_PERMISSION_SUPER_UTILISATEUR,
		       "sync_units" => NIVEAU_PERMISSION_SUPER_UTILISATEUR,
		...
		"ajoutlabo" => NIVEAU_PERMISSION_BUREAU,
